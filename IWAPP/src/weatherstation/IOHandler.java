...
public class IOHandler {
	...
	private MatrixTextHandler matrixHandler;
	...
	public IOHandler() {
		IO.init();
		matrixHandler = new MatrixTextHandler();
	}
	...
	public MatrixTextHandler getMatrixHandler() {
	...
	public static class MatrixHandler {
		...
		private static final int CLEAR_CODE = 3;
	...
	public static class MatrixTextHandler extends MatrixHandler {

		int row = 0;
		int index = 0;

		private MatrixTextHandler() {
